...
This is basically [`boot.loader.raspberry-pi` options](https://search.nixos.org/options?channel=unstable&show=boot.loader.raspberry-pi), which are deprecated in nixpkgs, but updated and improved upon.
...
We found [`boot.loader.raspberry-pi` options](https://search.nixos.org/options?channel=unstable&show=boot.loader.raspberry-pi) to be much more idiomatic, easier to extend, and maintain.
